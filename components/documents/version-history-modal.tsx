              ...
              {sortedVersions.map((version) => (
                <tr key={version.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-4">
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-gray-900">{version.file_name}</span>
                  ...
                  <td className="whitespace-nowrap px-4 py-4">
                    {version.is_published ? (
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-full border border-gray-300 px-2.5 py-0.5 text-xs font-medium text-gray-700 hover:bg-gray-50"
                      >
                        Set as Published
                      </button>
                    )}
